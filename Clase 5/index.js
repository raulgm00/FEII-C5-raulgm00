...
// const getClass = div.getAttribute('class')
// console.log(getClass)

// //Ejemplo para remover class
...
for(let i = 0; i < imgArr.length; i++){
    ...
    caja.classList.add('estilos-caja')
    img.setAttribute('src', imgArr[i].url)
    img.setAttribute('width', '200')
    h2.textContent = imgArr[i].name
...
//     const hasClass = div.classList.contains('estilo1')
//     console.log(hasClass)
//     if(hasClass){
//         div.classList.remove('estilo1')
//         div.classList.add('estilo2')
//     } else {
//         div.classList.remove('estilo2')
//         div.classList.add('estilo1')
//     }
